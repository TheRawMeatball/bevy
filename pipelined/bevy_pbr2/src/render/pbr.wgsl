...
fn fragment(in: FragmentInput) -> [[location(0)]] vec4<f32> {
    ...
    if ((material.flags & FLAGS_UNLIT_BIT) == 0u) {
        ...
        for (var i: i32 = 0; i < i32(lights.num_lights); i = i + 1) {
            ...
            let frag_ls = light.position.xyz - in.world_position.xyz;
            ...
            let proj_r = light.range.y / (light.range.x - light.range.y);
            let z = -major_axis_magnitude * proj_r + light.range.x * proj_r;
